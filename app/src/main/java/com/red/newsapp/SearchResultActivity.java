    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(v -> {
            ...
            if (searchedInput.isEmpty()) {
                Toast.makeText(this, "Silakan masukkan kata yang ingin Anda cari.", Toast.LENGTH_SHORT).show();
            } else {
                getSearchedArticles(searchedInput);
            }
        });
    ...
    private void getSearchedArticles(String searchedInput) {
        ...
        call.enqueue(new Callback<Articles>() {
            ...
            public void onResponse(Call<Articles> call, Response<Articles> response) {
                ...
                if (articles != null) {
                    tvSearchResult.setText(searchedInput + " memiliki sekitar " + articles.getTotalResults() + " hasil yang ditemukan.");
                    ...
                    Toast.makeText(SearchResultActivity.this, "Artikel berita tidak tersedia.", Toast.LENGTH_SHORT).show();
                }
            }
